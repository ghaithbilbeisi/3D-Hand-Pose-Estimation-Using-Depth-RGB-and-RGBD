...
{
    "distutils": {
        "name": "evaluation.image_loops",
        "sources": [
            "image_loops.pyx"
        ]
    },
    "module_name": "evaluation.image_loops"
}
END: Cython Metadata */
...
#define __PYX_HAVE__evaluation__image_loops
#define __PYX_HAVE_API__evaluation__image_loops
/* Early includes */
#include "pythread.h"
#include <string.h>
#include <stdlib.h>
...
/* Module declarations from 'evaluation.image_loops' */
...
static __Pyx_memviewslice __pyx_f_10evaluation_11image_loops_depth2cords(__Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
static __Pyx_memviewslice __pyx_f_10evaluation_11image_loops_color_map(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "evaluation.image_loops"
extern int __pyx_module_is_main_evaluation__image_loops;
int __pyx_module_is_main_evaluation__image_loops = 0;

/* Implementation of 'evaluation.image_loops' */
...
static const char __pyx_k_d_img[] = "d_img";
...
static const char __pyx_k_c_cords[] = "c_cords";
...
static const char __pyx_k_img_cords[] = "img_cords";
...
static PyObject *__pyx_n_s_c_cords;
...
static PyObject *__pyx_n_s_d_img;
...
static PyObject *__pyx_n_s_img_cords;
...
static PyObject *__pyx_pf_10evaluation_11image_loops_depth2cords(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_d_img, __Pyx_memviewslice __pyx_v_img_cords); /* proto */
static PyObject *__pyx_pf_10evaluation_11image_loops_2color_map(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_d_img, __Pyx_memviewslice __pyx_v_c_img, __Pyx_memviewslice __pyx_v_rgbd_img, __Pyx_memviewslice __pyx_v_c_cords); /* proto */
...
static PyObject *__pyx_pw_10evaluation_11image_loops_1depth2cords(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static __Pyx_memviewslice __pyx_f_10evaluation_11image_loops_depth2cords(__Pyx_memviewslice __pyx_v_d_img, __Pyx_memviewslice __pyx_v_img_cords, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_x;
  int __pyx_v_y;
  int __pyx_v_w;
  int __pyx_v_h;
  ...
  __Pyx_RefNannySetupContext("depth2cords", 0);

  /* "evaluation/image_loops.pyx":11
 * 
 ...
 *     # loop over the image
 */
  __pyx_v_h = (__pyx_v_d_img.shape[0]);

  /* "evaluation/image_loops.pyx":12
 *     # grab the image dimensions
 *     h = d_img.shape[0]
 *     w = d_img.shape[1]             # <<<<<<<<<<<<<<
 *     # loop over the image
 *     for y in range(0, h):
 */
  __pyx_v_w = (__pyx_v_d_img.shape[1]);

  /* "evaluation/image_loops.pyx":14
 *     w = d_img.shape[1]
 *     # loop over the image
 *     for y in range(0, h):             # <<<<<<<<<<<<<<
 *         for x in range(0, w):
 ...
 */
      ...
      __pyx_t_8 = __pyx_v_x;
      __pyx_t_9 = 0;
      if (__pyx_t_7 < 0) __pyx_t_7 += __pyx_v_img_cords.shape[0];
      if (__pyx_t_8 < 0) __pyx_t_8 += __pyx_v_img_cords.shape[1];
      if (__pyx_t_9 < 0) __pyx_t_9 += __pyx_v_img_cords.shape[2];
      *((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_img_cords.data + __pyx_t_7 * __pyx_v_img_cords.strides[0]) ) + __pyx_t_8 * __pyx_v_img_cords.strides[1]) ) + __pyx_t_9 * __pyx_v_img_cords.strides[2]) )) = __pyx_v_x;

      /* "evaluation/image_loops.pyx":18
 *             #image[y, x] = 255 if image[y, x] >= T else 0
 *             img_cords[y,x][0] = x
 *             img_cords[y,x][1] = y             # <<<<<<<<<<<<<<
 *             img_cords[y,x][2] = d_img[y,x]
 ...
 */
      ...
      __pyx_t_12 = 1;
      if (__pyx_t_10 < 0) __pyx_t_10 += __pyx_v_img_cords.shape[0];
      if (__pyx_t_11 < 0) __pyx_t_11 += __pyx_v_img_cords.shape[1];
      if (__pyx_t_12 < 0) __pyx_t_12 += __pyx_v_img_cords.shape[2];
      *((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_img_cords.data + __pyx_t_10 * __pyx_v_img_cords.strides[0]) ) + __pyx_t_11 * __pyx_v_img_cords.strides[1]) ) + __pyx_t_12 * __pyx_v_img_cords.strides[2]) )) = __pyx_v_y;

      /* "evaluation/image_loops.pyx":19
 *             img_cords[y,x][0] = x
 *             img_cords[y,x][1] = y
 *             img_cords[y,x][2] = d_img[y,x]             # <<<<<<<<<<<<<<
 *     return img_cords
 ...
 */
      ...
      if (__pyx_t_13 < 0) __pyx_t_13 += __pyx_v_d_img.shape[0];
      if (__pyx_t_14 < 0) __pyx_t_14 += __pyx_v_d_img.shape[1];
      __pyx_t_15 = __pyx_v_y;
      __pyx_t_16 = __pyx_v_x;
      __pyx_t_17 = 2;
      if (__pyx_t_15 < 0) __pyx_t_15 += __pyx_v_img_cords.shape[0];
      if (__pyx_t_16 < 0) __pyx_t_16 += __pyx_v_img_cords.shape[1];
      if (__pyx_t_17 < 0) __pyx_t_17 += __pyx_v_img_cords.shape[2];
      *((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_img_cords.data + __pyx_t_15 * __pyx_v_img_cords.strides[0]) ) + __pyx_t_16 * __pyx_v_img_cords.strides[1]) ) + __pyx_t_17 * __pyx_v_img_cords.strides[2]) )) = (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_d_img.data + __pyx_t_13 * __pyx_v_d_img.strides[0]) ) + __pyx_t_14 * __pyx_v_d_img.strides[1]) )));
    }
  }

  /* "evaluation/image_loops.pyx":20
 *             img_cords[y,x][1] = y
 *             img_cords[y,x][2] = d_img[y,x]
 *     return img_cords             # <<<<<<<<<<<<<<
 * 
 * @cython.boundscheck(False)
 */
  __PYX_INC_MEMVIEW(&__pyx_v_img_cords, 0);
  __pyx_r = __pyx_v_img_cords;
  goto __pyx_L0;
...
/* Python wrapper */
static PyObject *__pyx_pw_10evaluation_11image_loops_1depth2cords(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_10evaluation_11image_loops_1depth2cords(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_d_img = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_img_cords = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("depth2cords (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_d_img,&__pyx_n_s_img_cords,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_d_img)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_img_cords)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("depth2cords", 1, 2, 2, 1); __PYX_ERR(0, 6, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "depth2cords") < 0)) __PYX_ERR(0, 6, __pyx_L3_error)
      }
    ...
    __pyx_v_d_img = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_d_img.memview)) __PYX_ERR(0, 6, __pyx_L3_error)
    __pyx_v_img_cords = __Pyx_PyObject_to_MemoryviewSlice_dsdsds_double(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_img_cords.memview)) __PYX_ERR(0, 6, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("depth2cords", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 6, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("evaluation.image_loops.depth2cords", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_10evaluation_11image_loops_depth2cords(__pyx_self, __pyx_v_d_img, __pyx_v_img_cords);
...
static PyObject *__pyx_pf_10evaluation_11image_loops_depth2cords(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_d_img, __Pyx_memviewslice __pyx_v_img_cords) {
  ...
  if (unlikely(!__pyx_v_d_img.memview)) { __Pyx_RaiseUnboundLocalError("d_img"); __PYX_ERR(0, 6, __pyx_L1_error) }
  if (unlikely(!__pyx_v_img_cords.memview)) { __Pyx_RaiseUnboundLocalError("img_cords"); __PYX_ERR(0, 6, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_10evaluation_11image_loops_depth2cords(__pyx_v_d_img, __pyx_v_img_cords, 0); if (unlikely(!__pyx_t_1.memview)) __PYX_ERR(0, 6, __pyx_L1_error)
  __pyx_t_2 = __pyx_memoryview_fromslice(__pyx_t_1, 3, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 6, __pyx_L1_error)
  ...
  __pyx_r = NULL;
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_d_img, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_img_cords, 1);
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}

/* "evaluation/image_loops.pyx":23
 * 
 * @cython.boundscheck(False)
...
static PyObject *__pyx_pw_10evaluation_11image_loops_3color_map(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static __Pyx_memviewslice __pyx_f_10evaluation_11image_loops_color_map(__Pyx_memviewslice __pyx_v_d_img, __Pyx_memviewslice __pyx_v_c_img, __Pyx_memviewslice __pyx_v_rgbd_img, __Pyx_memviewslice __pyx_v_c_cords, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_x;
  int __pyx_v_y;
  int __pyx_v_w;
  int __pyx_v_h;
  ...
  __Pyx_RefNannySetupContext("color_map", 0);

  /* "evaluation/image_loops.pyx":28
 * 
 *     # grab the image dimensions
 *     h = rgbd_img.shape[0]             # <<<<<<<<<<<<<<
 *     w = rgbd_img.shape[1]
 *     # loop over the image
 */
  __pyx_v_h = (__pyx_v_rgbd_img.shape[0]);

  /* "evaluation/image_loops.pyx":29
 *     # grab the image dimensions
 *     h = rgbd_img.shape[0]
 *     w = rgbd_img.shape[1]             # <<<<<<<<<<<<<<
 *     # loop over the image
 *     for y in range(0, h):
 */
  __pyx_v_w = (__pyx_v_rgbd_img.shape[1]);

  /* "evaluation/image_loops.pyx":31
 *     w = rgbd_img.shape[1]
 *     # loop over the image
 *     for y in range(0, h):             # <<<<<<<<<<<<<<
 *         for x in range(0, w):
 ...
 */
      ...
      __pyx_t_8 = __pyx_v_x;
      __pyx_t_9 = 0;
      if (__pyx_t_7 < 0) __pyx_t_7 += __pyx_v_c_cords.shape[0];
      if (__pyx_t_8 < 0) __pyx_t_8 += __pyx_v_c_cords.shape[1];
      if (__pyx_t_9 < 0) __pyx_t_9 += __pyx_v_c_cords.shape[2];
      __pyx_t_10 = __Pyx_PyInt_FromDouble((*((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_c_cords.data + __pyx_t_7 * __pyx_v_c_cords.strides[0]) ) + __pyx_t_8 * __pyx_v_c_cords.strides[1]) ) + __pyx_t_9 * __pyx_v_c_cords.strides[2]) )))); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 33, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_10);
      __Pyx_XDECREF_SET(__pyx_v_c0, __pyx_t_10);
      __pyx_t_10 = 0;

      /* "evaluation/image_loops.pyx":34
 *         for x in range(0, w):
 *             c0 = int(c_cords[y,x][0])
 *             c1 = int(c_cords[y,x][1])             # <<<<<<<<<<<<<<
 *             if c1>=1080 or c0>=1920 or c1<0 or c0<0:
 ...
 */
      ...
      __pyx_t_13 = 1;
      if (__pyx_t_11 < 0) __pyx_t_11 += __pyx_v_c_cords.shape[0];
      if (__pyx_t_12 < 0) __pyx_t_12 += __pyx_v_c_cords.shape[1];
      if (__pyx_t_13 < 0) __pyx_t_13 += __pyx_v_c_cords.shape[2];
      __pyx_t_10 = __Pyx_PyInt_FromDouble((*((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_c_cords.data + __pyx_t_11 * __pyx_v_c_cords.strides[0]) ) + __pyx_t_12 * __pyx_v_c_cords.strides[1]) ) + __pyx_t_13 * __pyx_v_c_cords.strides[2]) )))); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 34, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_10);
      __Pyx_XDECREF_SET(__pyx_v_c1, __pyx_t_10);
      __pyx_t_10 = 0;

      /* "evaluation/image_loops.pyx":35
 *             c0 = int(c_cords[y,x][0])
 *             c1 = int(c_cords[y,x][1])
 *             if c1>=1080 or c0>=1920 or c1<0 or c0<0:             # <<<<<<<<<<<<<<
 *                 rgbd_img[y,x][0] = d_img[y,x]
 ...
 */
      __pyx_t_10 = PyObject_RichCompare(__pyx_v_c1, __pyx_int_1080, Py_GE); __Pyx_XGOTREF(__pyx_t_10); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 35, __pyx_L1_error)
      __pyx_t_15 = __Pyx_PyObject_IsTrue(__pyx_t_10); if (unlikely(__pyx_t_15 < 0)) __PYX_ERR(0, 35, __pyx_L1_error)
      ...
      __pyx_t_10 = PyObject_RichCompare(__pyx_v_c0, __pyx_int_1920, Py_GE); __Pyx_XGOTREF(__pyx_t_10); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 35, __pyx_L1_error)
      __pyx_t_15 = __Pyx_PyObject_IsTrue(__pyx_t_10); if (unlikely(__pyx_t_15 < 0)) __PYX_ERR(0, 35, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
      if (!__pyx_t_15) {
      } else {
      ...
      __pyx_t_10 = PyObject_RichCompare(__pyx_v_c1, __pyx_int_0, Py_LT); __Pyx_XGOTREF(__pyx_t_10); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 35, __pyx_L1_error)
      __pyx_t_15 = __Pyx_PyObject_IsTrue(__pyx_t_10); if (unlikely(__pyx_t_15 < 0)) __PYX_ERR(0, 35, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
      if (!__pyx_t_15) {
      } else {
      ...
      __pyx_t_10 = PyObject_RichCompare(__pyx_v_c0, __pyx_int_0, Py_LT); __Pyx_XGOTREF(__pyx_t_10); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 35, __pyx_L1_error)
      __pyx_t_15 = __Pyx_PyObject_IsTrue(__pyx_t_10); if (unlikely(__pyx_t_15 < 0)) __PYX_ERR(0, 35, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
      __pyx_t_14 = __pyx_t_15;
 ...
 */
        ...
        if (__pyx_t_16 < 0) __pyx_t_16 += __pyx_v_d_img.shape[0];
        if (__pyx_t_17 < 0) __pyx_t_17 += __pyx_v_d_img.shape[1];
        __pyx_t_18 = __pyx_v_y;
        __pyx_t_19 = __pyx_v_x;
        __pyx_t_20 = 0;
        if (__pyx_t_18 < 0) __pyx_t_18 += __pyx_v_rgbd_img.shape[0];
        if (__pyx_t_19 < 0) __pyx_t_19 += __pyx_v_rgbd_img.shape[1];
        if (__pyx_t_20 < 0) __pyx_t_20 += __pyx_v_rgbd_img.shape[2];
        *((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_rgbd_img.data + __pyx_t_18 * __pyx_v_rgbd_img.strides[0]) ) + __pyx_t_19 * __pyx_v_rgbd_img.strides[1]) ) + __pyx_t_20 * __pyx_v_rgbd_img.strides[2]) )) = (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_d_img.data + __pyx_t_16 * __pyx_v_d_img.strides[0]) ) + __pyx_t_17 * __pyx_v_d_img.strides[1]) )));

        /* "evaluation/image_loops.pyx":37
 *             if c1>=1080 or c0>=1920 or c1<0 or c0<0:
 *                 rgbd_img[y,x][0] = d_img[y,x]
 *                 rgbd_img[y,x][1] = d_img[y,x]             # <<<<<<<<<<<<<<
 *                 rgbd_img[y,x][2] = d_img[y,x]
 ...
 */
        ...
        if (__pyx_t_21 < 0) __pyx_t_21 += __pyx_v_d_img.shape[0];
        if (__pyx_t_22 < 0) __pyx_t_22 += __pyx_v_d_img.shape[1];
        __pyx_t_23 = __pyx_v_y;
        __pyx_t_24 = __pyx_v_x;
        __pyx_t_25 = 1;
        if (__pyx_t_23 < 0) __pyx_t_23 += __pyx_v_rgbd_img.shape[0];
        if (__pyx_t_24 < 0) __pyx_t_24 += __pyx_v_rgbd_img.shape[1];
        if (__pyx_t_25 < 0) __pyx_t_25 += __pyx_v_rgbd_img.shape[2];
        *((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_rgbd_img.data + __pyx_t_23 * __pyx_v_rgbd_img.strides[0]) ) + __pyx_t_24 * __pyx_v_rgbd_img.strides[1]) ) + __pyx_t_25 * __pyx_v_rgbd_img.strides[2]) )) = (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_d_img.data + __pyx_t_21 * __pyx_v_d_img.strides[0]) ) + __pyx_t_22 * __pyx_v_d_img.strides[1]) )));

        /* "evaluation/image_loops.pyx":38
 *                 rgbd_img[y,x][0] = d_img[y,x]
 *                 rgbd_img[y,x][1] = d_img[y,x]
 *                 rgbd_img[y,x][2] = d_img[y,x]             # <<<<<<<<<<<<<<
 *                 rgbd_img[y,x][3] = d_img[y,x]
 ...
 */
        ...
        if (__pyx_t_26 < 0) __pyx_t_26 += __pyx_v_d_img.shape[0];
        if (__pyx_t_27 < 0) __pyx_t_27 += __pyx_v_d_img.shape[1];
        __pyx_t_28 = __pyx_v_y;
        __pyx_t_29 = __pyx_v_x;
        __pyx_t_30 = 2;
        if (__pyx_t_28 < 0) __pyx_t_28 += __pyx_v_rgbd_img.shape[0];
        if (__pyx_t_29 < 0) __pyx_t_29 += __pyx_v_rgbd_img.shape[1];
        if (__pyx_t_30 < 0) __pyx_t_30 += __pyx_v_rgbd_img.shape[2];
        *((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_rgbd_img.data + __pyx_t_28 * __pyx_v_rgbd_img.strides[0]) ) + __pyx_t_29 * __pyx_v_rgbd_img.strides[1]) ) + __pyx_t_30 * __pyx_v_rgbd_img.strides[2]) )) = (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_d_img.data + __pyx_t_26 * __pyx_v_d_img.strides[0]) ) + __pyx_t_27 * __pyx_v_d_img.strides[1]) )));

        /* "evaluation/image_loops.pyx":39
 *                 rgbd_img[y,x][1] = d_img[y,x]
 *                 rgbd_img[y,x][2] = d_img[y,x]
 *                 rgbd_img[y,x][3] = d_img[y,x]             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
        ...
        if (__pyx_t_31 < 0) __pyx_t_31 += __pyx_v_d_img.shape[0];
        if (__pyx_t_32 < 0) __pyx_t_32 += __pyx_v_d_img.shape[1];
        __pyx_t_33 = __pyx_v_y;
        __pyx_t_34 = __pyx_v_x;
        __pyx_t_35 = 3;
        if (__pyx_t_33 < 0) __pyx_t_33 += __pyx_v_rgbd_img.shape[0];
        if (__pyx_t_34 < 0) __pyx_t_34 += __pyx_v_rgbd_img.shape[1];
        if (__pyx_t_35 < 0) __pyx_t_35 += __pyx_v_rgbd_img.shape[2];
        *((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_rgbd_img.data + __pyx_t_33 * __pyx_v_rgbd_img.strides[0]) ) + __pyx_t_34 * __pyx_v_rgbd_img.strides[1]) ) + __pyx_t_35 * __pyx_v_rgbd_img.strides[2]) )) = (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_d_img.data + __pyx_t_31 * __pyx_v_d_img.strides[0]) ) + __pyx_t_32 * __pyx_v_d_img.strides[1]) )));
 ...
 */
      /*else*/ {
        __pyx_t_36 = __Pyx_PyIndex_AsSsize_t(__pyx_v_c1); if (unlikely((__pyx_t_36 == (Py_ssize_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 41, __pyx_L1_error)
        __pyx_t_37 = __Pyx_PyIndex_AsSsize_t(__pyx_v_c0); if (unlikely((__pyx_t_37 == (Py_ssize_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 41, __pyx_L1_error)
        __pyx_t_38 = __pyx_t_36;
        __pyx_t_39 = __pyx_t_37;
        __pyx_t_40 = 0;
        if (__pyx_t_38 < 0) __pyx_t_38 += __pyx_v_c_img.shape[0];
        if (__pyx_t_39 < 0) __pyx_t_39 += __pyx_v_c_img.shape[1];
        if (__pyx_t_40 < 0) __pyx_t_40 += __pyx_v_c_img.shape[2];
        __pyx_t_41 = __pyx_v_y;
        __pyx_t_42 = __pyx_v_x;
        __pyx_t_43 = 0;
        if (__pyx_t_41 < 0) __pyx_t_41 += __pyx_v_rgbd_img.shape[0];
        if (__pyx_t_42 < 0) __pyx_t_42 += __pyx_v_rgbd_img.shape[1];
        if (__pyx_t_43 < 0) __pyx_t_43 += __pyx_v_rgbd_img.shape[2];
        *((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_rgbd_img.data + __pyx_t_41 * __pyx_v_rgbd_img.strides[0]) ) + __pyx_t_42 * __pyx_v_rgbd_img.strides[1]) ) + __pyx_t_43 * __pyx_v_rgbd_img.strides[2]) )) = (*((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_c_img.data + __pyx_t_38 * __pyx_v_c_img.strides[0]) ) + __pyx_t_39 * __pyx_v_c_img.strides[1]) ) + __pyx_t_40 * __pyx_v_c_img.strides[2]) )));

        /* "evaluation/image_loops.pyx":42
 *             else:
 *                 rgbd_img[y,x][0] = c_img[c1,c0][0]
 *                 rgbd_img[y,x][1] = c_img[c1,c0][1]             # <<<<<<<<<<<<<<
 *                 rgbd_img[y,x][2] = c_img[c1,c0][2]
 *                 rgbd_img[y,x][3] = d_img[y,x]
 */
        __pyx_t_37 = __Pyx_PyIndex_AsSsize_t(__pyx_v_c1); if (unlikely((__pyx_t_37 == (Py_ssize_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 42, __pyx_L1_error)
        __pyx_t_36 = __Pyx_PyIndex_AsSsize_t(__pyx_v_c0); if (unlikely((__pyx_t_36 == (Py_ssize_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 42, __pyx_L1_error)
        __pyx_t_44 = __pyx_t_37;
        __pyx_t_45 = __pyx_t_36;
        __pyx_t_46 = 1;
        if (__pyx_t_44 < 0) __pyx_t_44 += __pyx_v_c_img.shape[0];
        if (__pyx_t_45 < 0) __pyx_t_45 += __pyx_v_c_img.shape[1];
        if (__pyx_t_46 < 0) __pyx_t_46 += __pyx_v_c_img.shape[2];
        __pyx_t_47 = __pyx_v_y;
        __pyx_t_48 = __pyx_v_x;
        __pyx_t_49 = 1;
        if (__pyx_t_47 < 0) __pyx_t_47 += __pyx_v_rgbd_img.shape[0];
        if (__pyx_t_48 < 0) __pyx_t_48 += __pyx_v_rgbd_img.shape[1];
        if (__pyx_t_49 < 0) __pyx_t_49 += __pyx_v_rgbd_img.shape[2];
        *((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_rgbd_img.data + __pyx_t_47 * __pyx_v_rgbd_img.strides[0]) ) + __pyx_t_48 * __pyx_v_rgbd_img.strides[1]) ) + __pyx_t_49 * __pyx_v_rgbd_img.strides[2]) )) = (*((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_c_img.data + __pyx_t_44 * __pyx_v_c_img.strides[0]) ) + __pyx_t_45 * __pyx_v_c_img.strides[1]) ) + __pyx_t_46 * __pyx_v_c_img.strides[2]) )));

        /* "evaluation/image_loops.pyx":43
 *                 rgbd_img[y,x][0] = c_img[c1,c0][0]
 *                 rgbd_img[y,x][1] = c_img[c1,c0][1]
 *                 rgbd_img[y,x][2] = c_img[c1,c0][2]             # <<<<<<<<<<<<<<
 *                 rgbd_img[y,x][3] = d_img[y,x]
 *     return rgbd_img
 */
        __pyx_t_36 = __Pyx_PyIndex_AsSsize_t(__pyx_v_c1); if (unlikely((__pyx_t_36 == (Py_ssize_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 43, __pyx_L1_error)
        __pyx_t_37 = __Pyx_PyIndex_AsSsize_t(__pyx_v_c0); if (unlikely((__pyx_t_37 == (Py_ssize_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 43, __pyx_L1_error)
        __pyx_t_50 = __pyx_t_36;
        __pyx_t_51 = __pyx_t_37;
        __pyx_t_52 = 2;
        if (__pyx_t_50 < 0) __pyx_t_50 += __pyx_v_c_img.shape[0];
        if (__pyx_t_51 < 0) __pyx_t_51 += __pyx_v_c_img.shape[1];
        if (__pyx_t_52 < 0) __pyx_t_52 += __pyx_v_c_img.shape[2];
        __pyx_t_53 = __pyx_v_y;
        __pyx_t_54 = __pyx_v_x;
        __pyx_t_55 = 2;
        if (__pyx_t_53 < 0) __pyx_t_53 += __pyx_v_rgbd_img.shape[0];
        if (__pyx_t_54 < 0) __pyx_t_54 += __pyx_v_rgbd_img.shape[1];
        if (__pyx_t_55 < 0) __pyx_t_55 += __pyx_v_rgbd_img.shape[2];
        *((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_rgbd_img.data + __pyx_t_53 * __pyx_v_rgbd_img.strides[0]) ) + __pyx_t_54 * __pyx_v_rgbd_img.strides[1]) ) + __pyx_t_55 * __pyx_v_rgbd_img.strides[2]) )) = (*((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_c_img.data + __pyx_t_50 * __pyx_v_c_img.strides[0]) ) + __pyx_t_51 * __pyx_v_c_img.strides[1]) ) + __pyx_t_52 * __pyx_v_c_img.strides[2]) )));

        /* "evaluation/image_loops.pyx":44
 *                 rgbd_img[y,x][1] = c_img[c1,c0][1]
 *                 rgbd_img[y,x][2] = c_img[c1,c0][2]
 *                 rgbd_img[y,x][3] = d_img[y,x]             # <<<<<<<<<<<<<<
 *     return rgbd_img
 */
        ...
        if (__pyx_t_56 < 0) __pyx_t_56 += __pyx_v_d_img.shape[0];
        if (__pyx_t_57 < 0) __pyx_t_57 += __pyx_v_d_img.shape[1];
        __pyx_t_58 = __pyx_v_y;
        __pyx_t_59 = __pyx_v_x;
        __pyx_t_60 = 3;
        if (__pyx_t_58 < 0) __pyx_t_58 += __pyx_v_rgbd_img.shape[0];
        if (__pyx_t_59 < 0) __pyx_t_59 += __pyx_v_rgbd_img.shape[1];
        if (__pyx_t_60 < 0) __pyx_t_60 += __pyx_v_rgbd_img.shape[2];
        *((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_rgbd_img.data + __pyx_t_58 * __pyx_v_rgbd_img.strides[0]) ) + __pyx_t_59 * __pyx_v_rgbd_img.strides[1]) ) + __pyx_t_60 * __pyx_v_rgbd_img.strides[2]) )) = (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_d_img.data + __pyx_t_56 * __pyx_v_d_img.strides[0]) ) + __pyx_t_57 * __pyx_v_d_img.strides[1]) )));
      }
      __pyx_L7:;
    }
  }

  /* "evaluation/image_loops.pyx":45
 *                 rgbd_img[y,x][2] = c_img[c1,c0][2]
 *                 rgbd_img[y,x][3] = d_img[y,x]
 *     return rgbd_img             # <<<<<<<<<<<<<<
 */
  __PYX_INC_MEMVIEW(&__pyx_v_rgbd_img, 0);
  __pyx_r = __pyx_v_rgbd_img;
  goto __pyx_L0;
 ...
 */
  ...
  __Pyx_AddTraceback("evaluation.image_loops.color_map", __pyx_clineno, __pyx_lineno, __pyx_filename);
  goto __pyx_L2;
  __pyx_L0:;
  if (unlikely(!__pyx_r.memview)) {
    PyErr_SetString(PyExc_TypeError, "Memoryview return value is not initialized");
...
/* Python wrapper */
static PyObject *__pyx_pw_10evaluation_11image_loops_3color_map(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_10evaluation_11image_loops_3color_map(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_d_img = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_c_img = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_rgbd_img = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_c_cords = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("color_map (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_d_img,&__pyx_n_s_c_img,&__pyx_n_s_rgbd_img,&__pyx_n_s_c_cords,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_c_img)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("color_map", 1, 4, 4, 1); __PYX_ERR(0, 23, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_rgbd_img)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("color_map", 1, 4, 4, 2); __PYX_ERR(0, 23, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_c_cords)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("color_map", 1, 4, 4, 3); __PYX_ERR(0, 23, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "color_map") < 0)) __PYX_ERR(0, 23, __pyx_L3_error)
      }
    ...
    __pyx_v_d_img = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_d_img.memview)) __PYX_ERR(0, 23, __pyx_L3_error)
    __pyx_v_c_img = __Pyx_PyObject_to_MemoryviewSlice_dsdsds_double(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_c_img.memview)) __PYX_ERR(0, 23, __pyx_L3_error)
    __pyx_v_rgbd_img = __Pyx_PyObject_to_MemoryviewSlice_dsdsds_double(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_rgbd_img.memview)) __PYX_ERR(0, 23, __pyx_L3_error)
    __pyx_v_c_cords = __Pyx_PyObject_to_MemoryviewSlice_dsdsds_double(values[3], PyBUF_WRITABLE); if (unlikely(!__pyx_v_c_cords.memview)) __PYX_ERR(0, 23, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("color_map", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 23, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("evaluation.image_loops.color_map", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_10evaluation_11image_loops_2color_map(__pyx_self, __pyx_v_d_img, __pyx_v_c_img, __pyx_v_rgbd_img, __pyx_v_c_cords);
...
static PyObject *__pyx_pf_10evaluation_11image_loops_2color_map(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_d_img, __Pyx_memviewslice __pyx_v_c_img, __Pyx_memviewslice __pyx_v_rgbd_img, __Pyx_memviewslice __pyx_v_c_cords) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  __Pyx_memviewslice __pyx_t_1 = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_t_2 = NULL;
  __Pyx_RefNannySetupContext("color_map", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_d_img.memview)) { __Pyx_RaiseUnboundLocalError("d_img"); __PYX_ERR(0, 23, __pyx_L1_error) }
  if (unlikely(!__pyx_v_c_img.memview)) { __Pyx_RaiseUnboundLocalError("c_img"); __PYX_ERR(0, 23, __pyx_L1_error) }
  if (unlikely(!__pyx_v_rgbd_img.memview)) { __Pyx_RaiseUnboundLocalError("rgbd_img"); __PYX_ERR(0, 23, __pyx_L1_error) }
  if (unlikely(!__pyx_v_c_cords.memview)) { __Pyx_RaiseUnboundLocalError("c_cords"); __PYX_ERR(0, 23, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_10evaluation_11image_loops_color_map(__pyx_v_d_img, __pyx_v_c_img, __pyx_v_rgbd_img, __pyx_v_c_cords, 0); if (unlikely(!__pyx_t_1.memview)) __PYX_ERR(0, 23, __pyx_L1_error)
  __pyx_t_2 = __pyx_memoryview_fromslice(__pyx_t_1, 3, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 23, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __PYX_XDEC_MEMVIEW(&__pyx_t_1, 1);
  __pyx_t_1.memview = NULL;
  __pyx_t_1.data = NULL;
  ...
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_d_img, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_c_img, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_rgbd_img, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_c_cords, 1);
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "evaluation.image_loops.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "evaluation.image_loops.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "evaluation.image_loops.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "evaluation.image_loops._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"depth2cords", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_10evaluation_11image_loops_1depth2cords, METH_VARARGS|METH_KEYWORDS, 0},
  {"color_map", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_10evaluation_11image_loops_3color_map, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_image_loops(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_image_loops},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_c_cords, __pyx_k_c_cords, sizeof(__pyx_k_c_cords), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_d_img, __pyx_k_d_img, sizeof(__pyx_k_d_img), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_img_cords, __pyx_k_img_cords, sizeof(__pyx_k_img_cords), 0, 0, 1, 1},
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initimage_loops(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initimage_loops(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_image_loops(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_image_loops(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_image_loops(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'image_loops' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_image_loops(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("image_loops", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_evaluation__image_loops) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "evaluation.image_loops")) {
      if (unlikely(PyDict_SetItemString(modules, "evaluation.image_loops", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init evaluation.image_loops", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init evaluation.image_loops");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
